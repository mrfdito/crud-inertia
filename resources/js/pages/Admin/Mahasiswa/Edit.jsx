...
// In a real Inertia.js app, this data would come from the controller.

// Mock implementation for Inertia.js for demonstration purposes
const Inertia = {
    put: (url, data) => {
        console.log(`UPDATING to ${url} with data:`, data);
...
// --- PAGE COMPONENT ---
export default function Edit({ mahasiswa = MOCK_MAHASISWA_DETAIL }) {
    ...
    return (
        <AdminLayout>
            <div className="mx-auto max-w-4xl">
                <div className="mb-6">
                    <h1 className="text-3xl font-bold text-slate-900">Edit Mahasiswa</h1>
                    <p className="mt-1 text-gray-500">
                        Perbarui detail data untuk <span className="font-semibold">{mahasiswa.nama}</span>.
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            ...
                            <FormInput
                                ...
                                required
                            />
                            <FormSelect id="jurusan" name="jurusan" label="Jurusan" value={data.jurusan || ''} onChange={handleChange}>
                            ...
                            <FormInput
                                ...
                                required
                            />
                            <FormSelect id="status" name="status" label="Status" value={data.status || 'Aktif'} onChange={handleChange}>
                        ...
                        <div className="mt-8 flex justify-end space-x-4">
                            ...
                            <button
                                type="submit"
                                className="inline-flex items-center justify-center rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                            >
                                <SaveIcon />
                                Update Data
                            </button>
